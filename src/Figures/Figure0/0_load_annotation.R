...
trid2gid%>% save_hashmap('trid2gid.hmp')
gid2gnm%>%save_hashmap('gid2gnm.hmp')
gnm2gid%>%save_hashmap('gnm2gid.hmp')
trid2gnm%>%save_hashmap('trid2gnm.hmp')
gnm2gid%>%save_hashmap('gnm2gid.hmp')
gnm2trid%>%save_hashmap('gnm2trid.hmp')
