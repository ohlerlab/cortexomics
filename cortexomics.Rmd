...
```{r f1 nap, out.width ='900px', out.height ='900px' ,fig.cap = "caption", dev='pdf'}
...
## Figure 2 Riboseq
```{r f2 nap, out.width ='900px', out.height ='900px' ,fig.cap = "caption", dev='pdf'}
include_graphics("plots/tmp.pdf")
...
```{r f3, out.width ='900px', out.height ='900px' ,fig.cap = "caption", dev='pdf'}
include_graphics("plots/tmp.pdf")
...
```{r f4, out.width ='900px', out.height ='900px' ,fig.cap = "caption", dev='pdf'}
include_graphics("plots/tmp.pdf")
```
