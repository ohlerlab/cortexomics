...
```{r f1 nap, out.width ='900px', out.height ='900px' ,fig.cap = "caption", dev='svg'}
...
```{r f2 nap, out.width ='900px', out.height ='900px' ,fig.cap = "caption", dev='svg'}
include_graphics("plots/tmp.pdf")
...
```{r f3, out.width ='900px', out.height ='900px' ,fig.cap = "caption", dev='svg'}
...
```{r f4, out.width ='900px', out.height ='900px' ,fig.cap = "caption", dev='svg'}
plot(3)
# include_graphics("plots/tmp.svg")
```
